...
## 목표
오픈 미션 기간동안 기획부터 개발까지 몰입하고, 개발한 엔진을 통해 학습 후 기간 내에 실제 한자 급수 자격증에 도전 혹은 취득하여 학습 엔진의 활용성 증명을 목표로 합니다.
...
## 프로젝트 진행 중 몰입의 self 기록 Q&A 링크
https://www.notion.so/23e356c74fc6806eb222c7c6a4db3e5a?source=copy_link